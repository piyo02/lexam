...
class Excel_services
{
    ...
    public function excel_config($_data)
    {
        ...
        foreach ($datas as $key => $data) {
            ...
            $PHPExcel->getActiveSheet()->setCellValue('C' . $row_data, $data->user_fullname); //D
            $PHPExcel->getActiveSheet()->setCellValue('D' . $row_data, $data->value); //D
            $PHPExcel->getActiveSheet()->setCellValue('E' . $row_data, 'Lulus/Tidak Lulus'); //D
